...
const Masterclass = () => {
          ...
          `}
            ...
            >
              ...
              ${isActive ? "" : "rotate-0"}`}
                ...
                <p
                    className={`text-sm font-light text-white leading-relaxed mt-3 transition-all duration-500 ease-in-out 
    ...
    return (
        <div className="flex flex-col items-start justify-start py-3 px-5 w-full">
            {/* Header */}
